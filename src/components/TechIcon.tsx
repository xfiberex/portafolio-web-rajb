...
const ICONS: Record<string, React.ReactElement> = {
  // Jest y TanStack: paths de simple-icons (CC0-1.0), mismo viewBox 24x24.
  // No se dibujaron a mano a proposito — ver T2-22.
  Jest: (
...
export function pickIcon(name?: string): React.ReactElement | null {
  ...
  if (/\bjest\b/i.test(n)) return ICONS.Jest
  if (/tanstack/i.test(n)) return ICONS["TanStack Query"]
